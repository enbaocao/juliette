                ...
                <div className="grid grid-cols-3 gap-2">
                  <button
                    ...
                    className={`px-3 py-2 text-xs rounded-lg border ${
                      mode === 'simple' ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
                    }`}
                  >
                    Simple
                  </button>
                  <button
                    ...
                    className={`px-3 py-2 text-xs rounded-lg border ${
                      mode === 'practice' ? 'bg-purple-600 text-white border-purple-600' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
                    }`}
                  >
                    Practice
                  </button>
                  <button
                    ...
                    className={`px-3 py-2 text-xs rounded-lg border ${
                      mode === 'animation' ? 'bg-green-600 text-white border-green-600' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
                    }`}
                  >
                    Animation
                  </button>
                      ...
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <span
                          className={`ml-2 px-2 py-0.5 text-xs rounded-full ${
                            q.mode === 'simple' ? 'bg-blue-100 text-blue-800' : q.mode === 'practice' ? 'bg-purple-100 text-purple-800' : 'bg-green-100 text-green-800'
                          }`}
                        >
                          {q.mode}
                        </span>
